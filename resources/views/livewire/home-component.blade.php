...
<main class="main">
                ...
                <div class="tab-header">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="tab-one" aria-selected="true">{{ trans('home.Featured') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two" aria-selected="false">{{ trans('home.Popular') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-three" data-bs-toggle="tab" data-bs-target="#tab-three" type="button" role="tab" aria-controls="tab-three" aria-selected="false">{{ trans('home.New Arrival') }}</button>
                        </li>
                    </ul>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            {{-- <a aria-label="Add To Cart" class="action-btn hover-up" href="#"><i wire:click.prevent="store({{$fproduct->id}},'{{$fproduct->name}}',{{$fproduct->regular_price}})"><i class="fi-rs-shopping-bag-add"></i></a> --}}
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            <span class="hot">Most viewed</span>
                                        </div>
                                    </div>
                                    <div class="product-content-wrap">
                                        <div class="product-category">
            ...
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    ...
                    <div class="banner-text d-md-block d-none">
                        <h4 class="mt-40 mb-15 text-brand">Mobile Services</h4>
                        <h1 class="mb-20 fw-600">We're an Mobile <br>Authorised Service Store</h1>
        ...
        <section class="section-padding">
            <div class="container wow fadeIn animated">
                <h3 class="mb-20 section-title"><span>Sale</span> Product</h3>
