                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="slider-nav-thumbnails pl-15 pr-15">
                                            ...
                                            <li data-thumb="{{asset('assets/imgs/products')}}/{{$image}}">
                                                <div><img src="{{asset('assets/imgs/products')}}/{{ $image }}"  alt="product images"></div>
                                                </li>
                                            @endif
                                    ...
                                    <div class="detail-info">
                                        ...
                                        {{-- <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="button" class="button button-add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})" ><i class="fi-rs-shopping-bag-add"></i>Add to cart</button>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="comment-list">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="text-center thumb">
                                                                    <img src="{{asset('imgs/page/avatar-7.jpg')}}" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="text-center thumb">
                                                                    <img src="{{asset('imgs/page/avatar-8.jpg')}}" alt="">
                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('product.details' ,['slug'=>$rproduct->slug])}}" tabindex="0">
                                                            ...
                                                            {{-- <img class="hover-img" src="{{asset('assets/imgs/shop/product')}}-2.jpg" alt=""> --}}
                                                        </a>
                                                    </div>
