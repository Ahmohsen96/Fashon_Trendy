                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    <div class="sort-by-product-wrap">
                                        ...
                                        <div class="sort-by-dropdown-wrap">
                                            <span> Defult Sorting <i class="fi-rs-angle-small-down"></i></span>
                                        </div>
                                    </div>
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy == 'Defult Sorting' ? 'active': ''}}"  href="#" wire:click.prevent="changeOrderBy('Defult Sorting')">Defult Sorting </a></li>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details' ,['slug'=>$product->slug])}}">
                                                ...
                                                <img class="hover-img" src="{{ asset('assets/imgs/shop/product')}}/{{$product->image}}" alt="{{$product->name}}">
                                            </a>
                                        </div>
